...
const Fetured = () => {
    return (
        <div className="feturedBg my-10 bg-black bg-opacity-40 bg-blend-overlay text-white">
     ...
     <div className="md:flex justify-center items-center py-16 pt-20 gap-12 ml-32">
            ...
            <button className="btn border-0 border-b-4 btn-outline mt-2">Read more</button>
            </div>
     </div>
